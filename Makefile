...
RULES_NO_SCAN += libagbsyscall libma clean clean-assets tidy tidymodern tidycheck tidyrelease generated clean-generated clean-teachables clean-teachables_intermediates
...
$(TESTELF): $(OBJ_DIR)/ld_script_test.ld $(OBJS) $(TEST_OBJS) libagbsyscall libma tools check-tools
...
$(ELF): $(LD_SCRIPT) $(OBJS) libagbsyscall libma
