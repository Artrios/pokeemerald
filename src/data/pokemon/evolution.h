const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_LATIAS]	 = {{EVO_MOVE , MOVE_SURF, SPECIES_LUGIA},
							{EVO_MAP , MAP_MT_CHIMNEY, SPECIES_HO_OH},
							{EVO_SPECIES , SPECIES_WAILORD, SPECIES_RELICANTH},
							{EVO_MOVE_TYPE , TYPE_STEEL, SPECIES_STEELIX},
							{EVO_SPECIES_TYPE , TYPE_DARK, SPECIES_UMBREON}},
};
