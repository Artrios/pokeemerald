...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TMBall = {0xFFFF, OBJ_EVENT_PAL_TAG_1, OBJ_EVENT_PAL_TAG_NONE, 128, 16, 16, 3, SHADOW_SIZE_S, TRUE, FALSE, TRACKS_NONE, &gObjectEventBaseOam_16x16, gObjectEventSpriteOamTables_16x16, gObjectEventImageAnimTable_Inanimate, gObjectEventPicTable_TMBall, gDummySpriteAffineAnimTable };

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_MegaStoneSparkle = {0xFFFF, OBJ_EVENT_PAL_TAG_1, OBJ_EVENT_PAL_TAG_NONE, 128, 16, 16, 3, SHADOW_SIZE_S, FALSE, FALSE, TRACKS_NONE, &gObjectEventBaseOam_16x16, gObjectEventSpriteOamTables_16x16, gObjectEventImageAnimTable_MegaStoneSparkle, gObjectEventPicTable_MegaStoneSparkle, gDummySpriteAffineAnimTable };
