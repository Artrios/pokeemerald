...
static void UpdateStatColToWindow(void)
{
	...
	if (gNatureStatTable[sMonSummaryScreen->summary.nature][0] == 0) {
		...
		PrintTextOnWindow(10, gText_Attack3, statsXPos, 17, 0, 13);
	}
	else {
		PrintTextOnWindow(10, gText_Attack3, statsXPos, 17, 0, 14);
	}
	...
	if (gNatureStatTable[sMonSummaryScreen->summary.nature][1] == 0) {
		...
		PrintTextOnWindow(10, gText_Defense3, statsXPos, 33, 0, 13);
	}
	else {
		PrintTextOnWindow(10, gText_Defense3, statsXPos, 33, 0, 14);
	}
	...
	if (gNatureStatTable[sMonSummaryScreen->summary.nature][3] == 0) {
		...
		PrintTextOnWindow(11, gText_SpAtk4, statsXPos, 1, 0, 13);
	}
	else {
		PrintTextOnWindow(11, gText_SpAtk4, statsXPos, 1, 0, 14);
	}
	...
	if (gNatureStatTable[sMonSummaryScreen->summary.nature][4] == 0) {
		...
		PrintTextOnWindow(11, gText_SpDef4, statsXPos, 17, 0, 13);
	}
	else {
		PrintTextOnWindow(11, gText_SpDef4, statsXPos, 17, 0, 14);
	}
	...
	if (gNatureStatTable[sMonSummaryScreen->summary.nature][2] == 0) {
		...
		PrintTextOnWindow(11, gText_Speed2, statsXPos, 33, 0, 13);
	}
	else {
		PrintTextOnWindow(11, gText_Speed2, statsXPos, 33, 0, 14);
	}
}
