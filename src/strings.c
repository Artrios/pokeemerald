...
const u8 gText_ReceiveMysteryGiftWithEReader[] = _("Lisez votre e-card CADEAU\nMYST. avec l’e-Reader.");
const u8 gText_SelectConnectFromEReaderMenu[] = _("Pour se connecter, sélectionnez\nl’option “Communication” dans\nle menu du e-Reader.");
...
const u8 gText_AllowEReaderToLoadCard[] = _("Veuillez scanner la carte\ndans l’e-Reader.");
const u8 gText_ConnectionComplete[] = _("Transfert terminé!");
const u8 gText_NewTrainerHasComeToHoenn[] = _("Un nouveau DRESSEUR est arrivé\ndans la région de HOENN.");
