...
ALIGNED(4) const u8 gText_PickPokemonOKCancel[] = _("{DPAD_LEFTRIGHT}Pick {A_BUTTON}Ok {B_BUTTON}Cancel");
...
const u8 gText_WithdrawPokemon2[] = _("Withdraw Pokémon?");
const u8 gText_ItemCaps[] = _("ITEM");
